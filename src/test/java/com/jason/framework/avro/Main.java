...
import com.jason.framework.avro.mail.Mail;
...
public class Main {
    public static class MailImpl implements Mail {
        ...
        public Utf8 send(Message message) {
            ...
            return new Utf8("服务端相应:Sending message to " + message.getTo().toString()
    ...
    public static void main(String[] a) throws IOException {
    	...
    	String[] args = new String[]{"avro_user","pat","Hello_World"};
        if (args.length != 3) {
        ...
        Message message = Message.newBuilder()
        		.setTo(new Utf8(args[0]))
        		.setFrom(new Utf8(args[1]))
        		.setBody(new Utf8(args[2]))
        		.build();
